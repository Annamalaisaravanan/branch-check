...
from branch_check_dbx.tasks.sample_etl_task import SampleETLTask
from branch_check_dbx.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/branch-check-dbx/sample_experiment"
    }
